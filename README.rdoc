= rolify {<img src="https://secure.travis-ci.org/EppO/rolify.png?branch=v2">}[http://travis-ci.org/EppO/rolify]
...
* >= Rails 3.1
* ActiveRecord ORM
* ruby 1.8/1.9, REE and Rubinius (JRuby support on going)
