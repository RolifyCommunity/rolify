= rolify {<img src="https://secure.travis-ci.org/EppO/rolify.png?branch=v3">}[http://travis-ci.org/EppO/rolify]
...
* {Usage}[https://github.com/EppO/rolify/wiki/Usage]: all the available commands and the 
